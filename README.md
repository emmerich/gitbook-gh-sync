<table>
  <thead>
    <tr>
      <th style="text-align:left"><b>Supported methods</b>
      </th>
  ...
  <tbody></tbody>
</table>A set of methods for interacting with elements. Once the element is located and retrieved \(by using the `findElement()` function or similar\), it can be managed using the following methods.
