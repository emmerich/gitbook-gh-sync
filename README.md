...
**Book**: An online version is available at <http://samypesse.gitbooks.io/how-to-create-an-operating-system/> (PDF, Mobi and ePub). It was generated using [GitBook](https://www.gitbook.com/).
